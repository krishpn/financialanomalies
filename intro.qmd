...
@fama1973risk two-parameter regression model estimates average risk-return relationships based on efficient market porfolio ($m$) constructed according to Equation \ref{Equation:BlackScholes1972} for an asset ($i$). 
...
\begin{align*}
    ...
    \caption{Definition of weighted market equilibirum (market portfloio) according to Black Scholes. This is assumed to be always efficient construction.}
\end{align*}
