...
\begin{align}
    ...
    &\text{where: } \nonumber \\
    &\text{LETQ, natural logarithm of total common equity - number of shares outstanding times (month-end) price per share }\nonumber \\
    &\text{Debt to Equity Ratio (DER)}\nonumber = \frac{book value of total assets -book value of common equity}{market value of common equity}\\
