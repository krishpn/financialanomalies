...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, borderline west={3pt}{0pt}{shadecolor}, sharp corners, enhanced, breakable, interior hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
Fama and MacBeth (1973) : Two-parameter risk-return regression equation
is based on Equation \ref{Equation:BlackScholes1972}:
