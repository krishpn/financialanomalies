...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, enhanced, frame hidden, sharp corners, interior hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
Fama and MacBeth (1973) defines two-parameter regression model estimates
average risk-return relationships based on efficient market porfolio
(\(m\)) constructed according to Equation
