...
Lundholm, and Matthew Van Winkle (2011) Landsman et al. (2011) K. K. Li
(2011) Thomas and Zhang (2011) Johnson and So (2012) Palazzo (2012)
Bazdrech, Belo, and Lin (2009) Cohen and Lou (2012) Hirshleifer, Hsu,
and Li (2013) Prakash and Sinha (2013) Cohen, Diether, and Malloy (2013)
...
Vanden (2006) Vanden (2004) K. C. Chan, Chen, and Hsieh (1985) Arbel,
Carvell, and Strebel (1983) Campbell (1996) Dittmar (2002) Liu (2006)
Pastor and Stambaugh (2003) Hirshleifer and Jiang (2010) Black (1972)
Carhart (1997) Black (1972) Kraus and Litzenberger (1976) Lintner (1965)
Sharpe (1964) Heckerman (1972) Heckerman (1972) Fama and MacBeth (1973)
Mossin (1966) Jagannathan and Wang (1996) Ferson and Harvey (1991)
Fogler, John, and Tipton (1981) Boudoukh et al. (2007) Hou, Xue, and
Zhang (2015) Holthausen and Larcker (1992) Easley, Hvidkjaer, and O'hara
...
and Vorkink (2010) J. An, Bhojraj, and Ng (2010) Hameed and Mian (2015)
...
(\textbf{huangalanguoming2009tcso?})
(\textbf{papanastasopoulosgeorgios2010tior?}) (\textbf{dazhi2011dsrr?})

Patatoukas (2012)

McLean and Pontiff (2016)

Baltussen, Van Bekkum, and Van der Grient (2012)

B.-J. An et al. (2014) X. Li (2010)
...
Boguth and Kuehn (2013)

Chordia, Huh, and Subrahmanyam (2009)

Baker and Wurgler (2006)

M. Cremers, Halling, and Weinbaum (2010)

K. M. Cremers, Nair, and John (2009)
...
Armstrong, Banerjee, and Corona (2011)

Hess, Kreutzmann, and Pucker (2010)
...
Gopalan, Kadan, and Pevzner (2012)
...
(\textbf{gu2011Overpriced?})

(\textbf{chen2012idiosyncratic?})
...
(\textbf{savov2011Asset?})

(\textbf{bansal1993arbitrage?})
...
Brennan, Wang, and Xia (2004)

K. Chan, Foresi, and Lang (1996)

Chapman (1997)

Cochrane (1996)

Bossaerts and Dammon (1994)

Korniotis (2008)

Breeden (1979)

Stulz (1986) George and Hwang (2010) (\textbf{livdan2009Financially?})
(\textbf{adler1983International?}) M. E. Rubinstein (1973)
(\textbf{constantinides1982Intertemporal?}) M. Rubinstein (1974)
(\textbf{sun2019Financing?}) (\textbf{garleanu2012Displacement?}) Cox,
Ingersoll Jr, and Ross (2005) (\textbf{lucas1978Asset?})
(\textbf{garlappi2011Financial?}) (\textbf{jarrow1980Heterogeneous?})
Merton (1973) (\textbf{constantinides1986Capital?}) Stulz (1981) Solnik
(1974) (\textbf{chordia2013Trends?}) (\textbf{ferson2013sample?})
(\textbf{akbas2013Time?}) (\textbf{doskov2016Tradable?})
(\textbf{jagannathan2007Lazy?}) (\textbf{vassalou2003News?})
(\textbf{jacobs2004Idiosyncratic?}) (\textbf{ozoguz2009Good?})
(\textbf{viale2012Safety?}) (\textbf{malloy2009Long?}) Sweeney and Warga
(1986) (\textbf{kumar2006Retail?}) (\textbf{oldfield1981Treasury?})
(\textbf{kapadia2011Tracking?}) Ferson and Harvey (1993)
(\textbf{ferson1994Sources?}) (\textbf{ferson1999Conditioning?})
(\textbf{heaton2000Portfolio?}) (\textbf{lustig2005Housing?})
(\textbf{fung1997Empirical?}) (\textbf{korajczyk2008Pricing?})
(\textbf{binsbergen2016Good?}) (\textbf{chen2014Contingent?}) Koijen,
Moskowitz, and Pedersen (2012) (\textbf{chen1986Economic?})
(\textbf{eiling2013Industry?}) (\textbf{li2006Sector?})
(\textbf{g2016Labor?}) (\textbf{bali2016Risk?}) (\textbf{hu2013Noise?})
(\textbf{berkman2011Time?}) Campbell et al. (2018)
(\textbf{chung2006Asset?}) (\textbf{erb1996Expected?})
(\textbf{elton1995Fundamental?}) (\textbf{elton1995Fundamental?})
(\textbf{wang2012Debt?}) (\textbf{da2009Long?})
(\textbf{jiang2014Dispersion?}) (\textbf{zhao2012Information?})
(\textbf{han2011Term?}) Callen and Lyle (2020)
(\textbf{botosan1997Disclosure?}) Loughran and Vijh (1997)
(\textbf{jones2002Short?}) (\textbf{rajgopal2003stock?})
...
\leavevmode\vadjust pre{\hypertarget{ref-ackert1997prior}{}}%
Ackert, Lucy F, and George Athanassakos. 1997. {``Prior Uncertainty,
Analyst Bias, and Subsequent Abnormal Returns.''} \emph{Journal of
Financial Research} 20 (2): 263--73.
...
\leavevmode\vadjust pre{\hypertarget{ref-adrian2008stock}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-an2014joint}{}}%
An, Byeong-Je, Andrew Ang, Turan G Bali, and Nusret Cakici. 2014. {``The
Joint Cross Section of Stocks and Options.''} \emph{The Journal of
Finance} 69 (5): 2279--2337.
...
\leavevmode\vadjust pre{\hypertarget{ref-armstrong2011information}{}}%
Armstrong, Christopher, Snehal Banerjee, and Carlos Corona. 2011.
\emph{Information Quality and the Cross-Section of Expected Returns}.
\emph{Wharton School, University of Pennsylvania}.
...
\leavevmode\vadjust pre{\hypertarget{ref-baik2007changes}{}}%
...
Baker, Malcolm, and Jeffrey Wurgler. 2006. {``Investor Sentiment and the
Cross-Section of Stock Returns.''} \emph{The Journal of Finance} 61 (4):
1645--80.
...
\leavevmode\vadjust pre{\hypertarget{ref-baltussen2012unknown}{}}%
Baltussen, Guido, Sjoerd Van Bekkum, and Bart Van der Grient. 2012.
{``Unknown Unknowns: Vol-of-Vol and the Cross Section of Stock
Returns.''} \emph{Erasmus University Working Paper}.

\leavevmode\vadjust pre{\hypertarget{ref-balvers2007productivity}{}}%
Balvers, Ronald J, and Dayong Huang. 2007. {``Productivity-Based Asset
Pricing: Theory and Evidence.''} \emph{Journal of Financial Economics}
86 (2): 405--45.

\leavevmode\vadjust pre{\hypertarget{ref-bansal2005consumption}{}}%
Bansal, Ravi, Robert F Dittmar, and Christian T Lundblad. 2005.
{``Consumption, Dividends, and the Cross Section of Equity Returns.''}
\emph{The Journal of Finance} 60 (4): 1639--72.
...
\leavevmode\vadjust pre{\hypertarget{ref-bauman1988growth}{}}%
Bauman, W Scott, and Richard Dowen. 1988. {``Growth Projections and
Common Stock Returns.''} \emph{Financial Analysts Journal} 44 (4):
79--80.
...
\leavevmode\vadjust pre{\hypertarget{ref-beneish1997detecting}{}}%
...
Performance.''} \emph{Journal of Accounting and Public Policy} 16 (3):
271--309.

\leavevmode\vadjust pre{\hypertarget{ref-beneish2013earnings}{}}%
Beneish, Messod D, Charles MC Lee, and D Craig Nichols. 2013.
{``Earnings Manipulation and Expected Returns.''} \emph{Financial
Analysts Journal} 69 (2): 57--82.
...
\leavevmode\vadjust pre{\hypertarget{ref-boguth2013consumption}{}}%
Boguth, Oliver, and Lars-Alexander Kuehn. 2013. {``Consumption
Volatility Risk.''} \emph{The Journal of Finance} 68 (6): 2589--2615.

\leavevmode\vadjust pre{\hypertarget{ref-bossaerts1994tax}{}}%
Bossaerts, Peter, and Robert M Dammon. 1994. {``Tax-Induced
Intertemporal Restrictions on Security Returns.''} \emph{The Journal of
Finance} 49 (4): 1347--71.
...
\leavevmode\vadjust pre{\hypertarget{ref-breeden1979intertemporal}{}}%
Breeden, Douglas T. 1979. {``An Intertemporal Asset Pricing Model with
Stochastic Consumption and Investment Opportunities.''} \emph{Journal of
Financial Economics} 7 (3): 265--96.

\leavevmode\vadjust pre{\hypertarget{ref-breeden1989empirical}{}}%
Breeden, Douglas T, Michael R Gibbons, and Robert H Litzenberger. 1989.
{``Empirical Tests of the Consumption-Oriented CAPM.''} \emph{The
Journal of Finance} 44 (2): 231--62.
...
\leavevmode\vadjust pre{\hypertarget{ref-brennan2013informed}{}}%
Brennan, Michael J, Sahn-Wook Huh, and Avanidhar Subrahmanyam. 2013.
{``Informed Trading and the Pricing of Good and Bad Private Information
in the Cross-Section of Expected Stock Returns.''} \emph{The World Bank
Paper}.
...
\leavevmode\vadjust pre{\hypertarget{ref-brennan2004estimation}{}}%
Brennan, Michael J, Ashley W Wang, and Yihong Xia. 2004. {``Estimation
and Test of a Simple Model of Intertemporal Capital Asset Pricing.''}
\emph{The Journal of Finance} 59 (4): 1743--76.

\leavevmode\vadjust pre{\hypertarget{ref-brown2007productivity}{}}%
Brown, David P, and Bradford Rowe. 2007. {``The Productivity Premium in
Equity Returns.''} \emph{Available at SSRN 993467}.

\leavevmode\vadjust pre{\hypertarget{ref-burlacu2012risk}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-callen2020term}{}}%
Callen, Jeffrey L, and Matthew R Lyle. 2020. {``The Term Structure of
Implied Costs of Equity Capital.''} \emph{Review of Accounting Studies}
25 (1): 342--404.
...
\leavevmode\vadjust pre{\hypertarget{ref-campbell2018intertemporal}{}}%
Campbell, John Y, Stefano Giglio, Christopher Polk, and Robert Turley.
2018. {``An Intertemporal CAPM with Stochastic Volatility.''}
\emph{Journal of Financial Economics} 128 (2): 207--33.
...
\leavevmode\vadjust pre{\hypertarget{ref-campbell2004bad}{}}%
Campbell, John Y, and Tuomo Vuolteenaho. 2004. {``Bad Beta, Good
Beta.''} \emph{American Economic Review} 94 (5): 1249--75.
...
\leavevmode\vadjust pre{\hypertarget{ref-cen2006forecasted}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-chan1996does}{}}%
Chan, KC, Silverio Foresi, and Larry HP Lang. 1996. {``Does Money
Explain Asset Returns? Theory and Empirical Analysis.''} \emph{The
Journal of Finance} 51 (1): 345--61.
...
\leavevmode\vadjust pre{\hypertarget{ref-chang2013market}{}}%
Chang, Bo Young, Peter Christoffersen, and Kris Jacobs. 2013. {``Market
Skewness Risk and the Cross Section of Stock Returns.''} \emph{Journal
of Financial Economics} 107 (1): 46--68.

\leavevmode\vadjust pre{\hypertarget{ref-chapman1997approximating}{}}%
Chapman, David A. 1997. {``Approximating the Asset Pricing Kernel.''}
\emph{The Journal of Finance} 52 (4): 1383--1410.
...
\leavevmode\vadjust pre{\hypertarget{ref-chordia2009theory}{}}%
Chordia, Tarun, Sahn-Wook Huh, and Avanidhar Subrahmanyam. 2009.
{``Theory-Based Illiquidity and Asset Pricing.''} \emph{The Review of
Financial Studies} 22 (9): 3629--68.
...
\leavevmode\vadjust pre{\hypertarget{ref-cochrane1996cross}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-cox2005theory}{}}%
Cox, John C, Jonathan E Ingersoll Jr, and Stephen A Ross. 2005. {``A
Theory of the Term Structure of Interest Rates.''} In \emph{Theory of
Valuation}, 129--64.
...
\leavevmode\vadjust pre{\hypertarget{ref-cremers2009takeovers}{}}%
Cremers, KJ Martijn, Vinay B Nair, and Kose John. 2009. {``Takeovers and
the Cross-Section of Returns.''} \emph{The Review of Financial Studies}
22 (4): 1409--45.

\leavevmode\vadjust pre{\hypertarget{ref-cremers2010search}{}}%
Cremers, Martijn, Michael Halling, and David Weinbaum. 2010. {``In
Search of Aggregate Jump and Volatility Risk in the Cross-Section of
Stock Returns.''} \emph{SSRN eLibrary}.

\leavevmode\vadjust pre{\hypertarget{ref-da2009cash}{}}%
Da, Zhi. 2009. {``Cash Flow, Consumption Risk, and the Cross-Section of
Stock Returns.''} \emph{The Journal of Finance} 64 (2): 923--56.
...
\leavevmode\vadjust pre{\hypertarget{ref-douglas1967risk}{}}%
Douglas, George Warren. 1967. \emph{Risk in the Equity Markets: An
Empirical Appraisal of Market Efficiency}. \emph{None}. Yale University.
...
\leavevmode\vadjust pre{\hypertarget{ref-durnev2009corporate}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ferson1993risk}{}}%
---------. 1993. {``The Risk and Predictability of International Equity
Returns.''} \emph{Review of Financial Studies} 6 (3): 527--66.
...
\leavevmode\vadjust pre{\hypertarget{ref-george2010resolution}{}}%
---------. 2010. {``A Resolution of the Distress Risk and Leverage
Puzzles in the Cross Section of Stock Returns.''} \emph{Journal of
Financial Economics} 96 (1): 56--79.

\leavevmode\vadjust pre{\hypertarget{ref-gokcen2009information}{}}%
Gokcen, Umut. 2009. {``Information Revelation and Expected Stock
Returns.''} In \emph{FMA 2009 Reno Meetings Paper, NFA}.
...
\leavevmode\vadjust pre{\hypertarget{ref-gopalan2012asset}{}}%
Gopalan, Radhakrishnan, Ohad Kadan, and Mikhail Pevzner. 2012. {``Asset
Liquidity and Stock Liquidity.''} \emph{Journal of Financial and
Quantitative Analysis} 47 (2): 333--64.
...
\leavevmode\vadjust pre{\hypertarget{ref-gu2005innovation}{}}%
Gu, Feng. 2005. {``Innovation, Future Earnings, and Market
Efficiency.''} \emph{Journal of Accounting, Auditing \& Finance} 20 (4):
385--418.
...
\leavevmode\vadjust pre{\hypertarget{ref-hess2010projected}{}}%
Hess, Dieter, Daniel Kreutzmann, and Oliver Pucker. 2010.
\emph{Projected Earnings Accuracy and the Profitability of Stock
Recommendations}. \emph{Centre for Financial Research}.
...
\leavevmode\vadjust pre{\hypertarget{ref-koijenevert}{}}%
Koijen, Ralph SJ, Tobias J Moskowitz, and Lasse Heje Pedersen. 2012.
{``Evert b. Vrugt Current Version: May 2012 Preliminary and
Incomplete.''} \emph{None}.

\leavevmode\vadjust pre{\hypertarget{ref-korniotis2008habit}{}}%
Korniotis, George M. 2008. {``Habit Formation, Incomplete Markets, and
the Significance of Regional Risk for Expected Returns.''} \emph{The
Review of Financial Studies} 21 (5): 2139--72.

\leavevmode\vadjust pre{\hypertarget{ref-korniotis2009geography}{}}%
Korniotis, George M, and Alok Kumar. 2009. {``The Geography of Return
Predictability.''} \emph{None}.
...
\leavevmode\vadjust pre{\hypertarget{ref-lettau2001resurrecting}{}}%
Lettau, Martin, and Sydney Ludvigson. 2001. {``Resurrecting the (c)
CAPM: A Cross-Sectional Test When Risk Premia Are Time-Varying.''}
\emph{Journal of Political Economy} 109 (6): 1238--87.

\leavevmode\vadjust pre{\hypertarget{ref-lev2016informational}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-gu2009information}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-li2010real}{}}%
Li, Xi. 2010. {``Real Earnings Management and Subsequent Stock
Returns.''} \emph{Available at SSRN 1679832}.
...
\leavevmode\vadjust pre{\hypertarget{ref-loughran1997long}{}}%
Loughran, Tim, and Anand M Vijh. 1997. {``Do Long-Term Shareholders
Benefit from Corporate Acquisitions?''} \emph{The Journal of Finance} 52
(5): 1765--90.
...
\leavevmode\vadjust pre{\hypertarget{ref-mclean2016does}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-merton1973intertemporal}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-ortiz2014real}{}}%
Ortiz-Molina, Hern'an, and Gordon M Phillips. 2014. {``Real Asset
Illiquidity and the Cost of Capital.''} \emph{Journal of Financial and
Quantitative Analysis} 49 (1): 1--32.
...
\leavevmode\vadjust pre{\hypertarget{ref-parker2005consumption}{}}%
Parker, Jonathan A, and Christian Julliard. 2005. {``Consumption Risk
and the Cross Section of Expected Returns.''} \emph{Journal of Political
Economy} 113 (1): 185--222.
...
\leavevmode\vadjust pre{\hypertarget{ref-PatatoukasPanosN.2012CCIf}{}}%
Patatoukas, Panos N. 2012. {``Customer-Base Concentration: Implications
for Firm Performance and Capital Markets.''} \emph{The Accounting
Review} 87 (2): 363--92.

\leavevmode\vadjust pre{\hypertarget{ref-penman2002modeling}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-rubinstein1974aggregation}{}}%
Rubinstein, Mark. 1974. {``An Aggregation Theorem for Securities
Markets.''} \emph{Journal of Financial Economics} 1 (3): 225--44.

\leavevmode\vadjust pre{\hypertarget{ref-rubinstein1973fundamental}{}}%
Rubinstein, Mark E. 1973. {``The Fundamental Theorem of
Parameter-Preference Security Valuation.''} \emph{Journal of Financial
and Quantitative Analysis} 8 (1): 61--69.
...
\leavevmode\vadjust pre{\hypertarget{ref-shu2007trader}{}}%
Shu, Tao. 2007. {``Trader Composition, Price Efficiency, and the
Cross-Section of Stock Returns.''} \emph{Available at SSRN 890656}.
Citeseer.
...
\leavevmode\vadjust pre{\hypertarget{ref-so2013new}{}}%
So, Eric C. 2013. {``A New Approach to Predicting Analyst Forecast
Errors: Do Investors Overweight Analyst Forecasts?''} \emph{Journal of
Financial Economics} 108 (3): 615--40.
...
\leavevmode\vadjust pre{\hypertarget{ref-solnik1974equilibrium}{}}%
Solnik, Bruno H. 1974. {``An Equilibrium Model of the International
Capital Market.''} \emph{Journal of Economic Theory} 8 (4): 500--524.
...
\leavevmode\vadjust pre{\hypertarget{ref-stulz1981model}{}}%
Stulz, Rene M. 1981. {``A Model of International Asset Pricing.''}
\emph{Journal of Financial Economics} 9 (4): 383--406.

\leavevmode\vadjust pre{\hypertarget{ref-stulz1986asset}{}}%
---------. 1986. {``Asset Pricing and Expected Inflation.''} \emph{The
Journal of Finance} 41 (1): 209--23.

\leavevmode\vadjust pre{\hypertarget{ref-sweeney1986pricing}{}}%
Sweeney, Richard J, and Arthur D Warga. 1986. {``The Pricing of
Interest-Rate Risk: Evidence from the Stock Market.''} \emph{The Journal
of Finance} 41 (2): 393--410.

\leavevmode\vadjust pre{\hypertarget{ref-teo2004style}{}}%
Teo, Melvyn, and Sung-Jun Woo. 2004. {``Style Effects in the
Cross-Section of Stock Returns.''} \emph{Journal of Financial Economics}
74 (2): 367--98.
...
\leavevmode\vadjust pre{\hypertarget{ref-vassalou2004default}{}}%
Vassalou, Maria, and Yuhang Xing. 2004. {``Default Risk in Equity
Returns.''} \emph{The Journal of Finance} 59 (2): 831--68.

\leavevmode\vadjust pre{\hypertarget{ref-wahlen2011can}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-xing2008interpreting}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-yogo2006consumption}{}}%
Yogo, Motohiro. 2006. {``A Consumption-Based Explanation of Expected
Stock Returns.''} \emph{The Journal of Finance} 61 (2): 539--80.
